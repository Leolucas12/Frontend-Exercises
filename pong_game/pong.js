...
function update(){
    if (keystate[38]) player.y -= 7
    if (keystate[40]) player.y += 7
    ...
    com.y += ((ball.y - (com.y + com.height/2)))*5/100;
    
    if(ball.y - ball.radius < 0 || ball.y + ball.radius > canvas.height){
        ball.velocityY = -ball.velocityY;
    }
    
    let playerCollision = (ball.x + ball.radius < canvas.width/2) ? player : com;
